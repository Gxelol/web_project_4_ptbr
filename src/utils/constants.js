...
export const inputUrlProfilePic = document.querySelector(".edit-profile__input-url");
...
export const editProfileButton = document.querySelector(".profile__image_edit-button");
...
export const saveProfilePicture = document.querySelector(".edit-profile__button");
